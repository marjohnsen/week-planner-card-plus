                ...
                <div class="rnr-actions">
                    ...
                    @click="${() => {
                      ...
                      const d = (e.originalStart && e.originalStart.toISODate) ? e.originalStart.toISODate()
                              ...
                              : null;
                      this._rnrOpenAddEventForDate(d);
                    }}">
...
_rnrOpenAddEventForDate(dt){
    try{
        // Close the event details dialog before opening the Add Event popup
        try { this._closeDialog(); } catch (e) {}
        ...
        try{history.pushState(null,"",`${window.location.pathname}${window.location.search}${hash}`);}catch(e){window.location.hash=hash;}window.dispatchEvent(new Event("location-changed"));window.dispatchEvent(new Event("hashchange"));
    }catch(err){}
}
