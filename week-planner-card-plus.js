        ...
        >
            <div class="content rnr-edit-form">
                ...
                <div class="rnr-edit-row" style="align-items:flex-start;">
                    <label class="rnr-edit-label">Repeat</label>
                    <div style="flex:1;">
                        ...
                        >
                            <option value="none" ?selected="${(d.repeat_freq||"none")==="none"}">No repeat</option>
                            <option value="daily" ?selected="${(d.repeat_freq||"none")==="daily"}">Daily</option>
                            <option value="weekly" ?selected="${(d.repeat_freq||"none")==="weekly"}">Weekly</option>
                            <option value="monthly" ?selected="${(d.repeat_freq||"none")==="monthly"}">Monthly</option>
                            <option value="yearly" ?selected="${(d.repeat_freq||"none")==="yearly"}">Yearly</option>
                        </select>
                        ...
                        ${ (d.repeat_freq && d.repeat_freq!=="none") ? W`
                            ...
                            <div style="margin-top:12px;">
                                <div style="display:flex; gap:10px; align-items:center;">
                                    ...
                                    >
                                        <option value="never" ?selected="${(d.repeat_end_type||"never")==="never"}">Never</option>
                                        <option value="until" ?selected="${(d.repeat_end_type||"never")==="until"}">On date</option>
